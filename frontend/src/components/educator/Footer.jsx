...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-900 px-8 md:px-36 text-left w-full mt-10">
      <div className="flex flex-col md:flex-row items-start justify-center gap-10 md:gap-32 py-10 border-b border-white/30">
        ...
        <div className="flex flex-col md:items-start items-center w-full">
          ...
          <p className="mt-6 text-center md:text-left text-sm text-white/80">
            Empowering education with technology and innovation.
          </p>
        </div>
      ...
      <p className="py-4 text-center text-xs md:text-sm text-white/60">
        Copyright 2025 © Paridhi Mittal. All Rights Reserved.
      </p>
    </footer>
  );
};
